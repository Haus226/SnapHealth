          ...
          reverse: true,
            children: [
              ...
              AnimatedPositioned(
                ...
                top: _isVisible ? MediaQuery.of(context).size.height * 0.35 : MediaQuery.of(context).size.height * 0.45,
                right: -10,
                left: -10,
                child: Card(
              ...
              AnimatedPositioned(
                duration: const Duration(seconds: 1),
                curve: Curves.easeInOut,
                top: _isVisible ? MediaQuery.of(context).size.height * 0.40 : MediaQuery.of(context).size.height * 0.50,
                right: -20,
                left: -20,
                child:
              Column(
